const log = [
	{
		...
		"changes": [
			...
			"Added [display canvas on myself] and [restore my look] blocks",
			...
			"Fixed bug where clipping areas weren't getting reset, when calling [reset everything] block or importing another project.",
	...
	},
	{
		...
		"changes": [
			...
			"Added [set [NAME] instance draw limit []] block for limiting the amount of drawn instances",
	...
	},
	{
		...
		"changes": [
			...
			"Added new blending mode \"default behind\", which draws new primitives behind what is already drawn",
			...
			"Fixed [set clear color R:[] G:[] B:[] A:[]] block to take into account premultiplied alpha",
			"Fixed bug where it would always use accurate interpolating for vertex colors regardless of what was set",
	...
	},
	{
		...
		"changes": [
			"Fixed [transform direction X: [X] Y: [Y] Z: [Z] from [FROM] to [TO]] block corrupting transformations that it was only meant to read",
